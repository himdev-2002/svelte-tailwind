<script lang="ts">
	...
	import DatePickerWithRange from '$lib/components/datepicker/date-picker-with-range.svelte';
	import DashboardLight from '$lib/img/dashboard-light.png?enhanced';
	import DashboardDark from '$lib/img/dashboard-dark.png?enhanced';
</script>
